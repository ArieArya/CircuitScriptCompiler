...
LL1_PARSE_TABLE = {
    ...
    # StatementList
    (NonTerminals.StatementList, str(Token(TokenClass.KEYWORD, 'wire'))): [
        NonTerminals.Statement,
        Token(TokenClass.SEMICOLON, ';'),
        NonTerminals.StatementList,
    ],
    (NonTerminals.StatementList, str(Token(TokenClass.KEYWORD, 'reg'))): [
        NonTerminals.Statement,
        Token(TokenClass.SEMICOLON, ';'),
        NonTerminals.StatementList,
    ],
    (NonTerminals.StatementList, str(Token(TokenClass.KEYWORD, 'lut'))): [
        NonTerminals.Statement,
        Token(TokenClass.SEMICOLON, ';'),
        NonTerminals.StatementList,
    ],
    (NonTerminals.StatementList, TokenClass.IDENTIFIER): [
        NonTerminals.Statement,
        Token(TokenClass.SEMICOLON, ';'),
        NonTerminals.StatementList,
    ],
    (NonTerminals.StatementList, str(Token(TokenClass.KEYWORD, 'print'))): [
        NonTerminals.Statement,
        Token(TokenClass.SEMICOLON, ';'),
        NonTerminals.StatementList,
    ],
    (NonTerminals.StatementList, str(Token(TokenClass.KEYWORD, 'if'))): [
        NonTerminals.Statement,
        Token(TokenClass.SEMICOLON, ';'),
        NonTerminals.StatementList,
    ],
    ...
    (NonTerminals.Declaration, str(Token(TokenClass.KEYWORD, 'wire'))): [
        Token(TokenClass.KEYWORD, 'wire'),
        TokenClass.IDENTIFIER,
        Token(TokenClass.OPERATOR, '='),
        NonTerminals.Expression,
    ],
    (NonTerminals.Declaration, str(Token(TokenClass.KEYWORD, 'reg'))): [
        Token(TokenClass.KEYWORD, 'reg'),
        TokenClass.IDENTIFIER,
        Token(TokenClass.OPERATOR, '='),
        NonTerminals.Expression,
    ],
    (NonTerminals.Declaration, str(Token(TokenClass.KEYWORD, 'lut'))): [
        Token(TokenClass.KEYWORD, 'lut'),
    ...
    # IfStmt
    (NonTerminals.IfStmt, str(Token(TokenClass.KEYWORD, 'if'))): [
        Token(TokenClass.KEYWORD, 'if'),
        Token(TokenClass.LPAREN, '('),
        NonTerminals.Expression,
        Token(TokenClass.OPERATOR, '=='),
        NonTerminals.Expression,
    ...
    # GateExpression
    (NonTerminals.GateExpression, str(Token(TokenClass.KEYWORD, 'and'))): [
        NonTerminals.GateType,
        Token(TokenClass.LPAREN, '('),
        NonTerminals.Arguments,
        str(Token(TokenClass.RPAREN, ')')),
    ],
    (NonTerminals.GateExpression, str(Token(TokenClass.KEYWORD, 'or'))): [
        NonTerminals.GateType,
        Token(TokenClass.LPAREN, '('),
        NonTerminals.Arguments,
        str(Token(TokenClass.RPAREN, ')')),
    ],
    (NonTerminals.GateExpression, str(Token(TokenClass.KEYWORD, 'not'))): [
        NonTerminals.GateType,
        Token(TokenClass.LPAREN, '('),
        NonTerminals.Arguments,
        str(Token(TokenClass.RPAREN, ')')),
    ],
    (NonTerminals.GateExpression, str(Token(TokenClass.KEYWORD, 'xor'))): [
        NonTerminals.GateType,
        Token(TokenClass.LPAREN, '('),
        NonTerminals.Arguments,
        str(Token(TokenClass.RPAREN, ')')),
    ...
    (NonTerminals.GateType, str(Token(TokenClass.KEYWORD, 'or'))): [
        Token(TokenClass.KEYWORD, 'or')
    ],
    (NonTerminals.GateType, str(Token(TokenClass.KEYWORD, 'not'))): [
        Token(TokenClass.KEYWORD, 'not')
    ],
